...
GENERIC_FOODS: tuple[GenericFoodEntry, ...] = (
    _food(
        ...
        3.2,
        49.0,
        aliases=("pan", "barra de pan", "pan comun"),
        fiber_g=2.7,
        salt_g=1.1,
    ),
    _food(
    ...
    _food(
        ...
        3.6,
        47.0,
        aliases=("pan bimbo", "pan sandwich", "pan tostado"),
        fiber_g=3.1,
        salt_g=1.0,
    ),
    _food(
        ...
        3.3,
        48.3,
        aliases=("pan negro", "pan de centeno integral"),
        fiber_g=5.8,
        salt_g=1.0,
    ),
    ...
    _food(
        ...
        4.8,
        46.0,
        aliases=("bollo de hamburguesa", "pan burger"),
        fiber_g=2.4,
        salt_g=1.1,
    ),
    _food(
        ...
        4.2,
        49.5,
        aliases=("pan perrito", "pan de perrito"),
        fiber_g=2.0,
        salt_g=1.1,
    ),
    _food(
        ...
        7.5,
        50.0,
        aliases=("wrap trigo", "fajita trigo"),
        fiber_g=3.2,
        salt_g=1.2,
    ),
    _food(
    ...
    _food(
        ...
        0.3,
        28.2,
        aliases=("arroz", "arroz blanco", "arroz hervido"),
        fiber_g=0.4,
        salt_g=0.0,
    ),
    _food(
        ...
        1.0,
        25.6,
        aliases=("arroz integral", "arroz integral hervido"),
        fiber_g=1.8,
        salt_g=0.0,
    ),
    _food(
        "arroz_basmati_cocido",
        "Arroz basmati cocido",
        121,
        3.5,
        0.4,
        25.0,
        aliases=("basmati", "arroz basmati"),
        fiber_g=0.7,
        salt_g=0.0,
    ),
    _food(
    ...
    _food(
        ...
        6.9,
        66.3,
        aliases=("copos de avena", "avena en hojuelas"),
        fiber_g=10.6,
        salt_g=0.0,
    ),
    ...
    _food(
        ...
        0.9,
        30.9,
        aliases=("pasta", "macarrones cocidos", "espaguetis cocidos"),
        fiber_g=1.8,
        salt_g=0.0,
    ),
    _food(
    ...
    _food(
        ...
        0.9,
        30.9,
        aliases=("espaguetis", "spaghetti"),
        fiber_g=1.8,
        salt_g=0.0,
    ),
    _food(
        "cuscus_cocido", "Cuscus cocido", 112, 3.8, 0.2, 23.2, aliases=("cous cous", "cuscus"), fiber_g=1.4, salt_g=0.0
    ),
    _food(
        "patata_cocida",
        "Patata cocida",
        ...
        0.1,
        20.1,
        aliases=("patata hervida", "papa cocida"),
        fiber_g=1.8,
        salt_g=0.0,
    ),
    ...
    _food(
        ...
        9.5,
        0.7,
        aliases=("huevo entero", "huevo de gallina"),
        sat_fat_g=3.1,
        salt_g=0.36,
        serving_size_g=60,
    ),
    ...
    _food(
        ...
        11.8,
        1.2,
        aliases=("tortilla de huevo", "omelette"),
        sat_fat_g=3.3,
        salt_g=0.5,
    ),
    _food(
    ...
    _food(
        ...
        2.6,
        0.0,
        aliases=("pollo", "pollo pechuga", "pollo a la plancha"),
        sat_fat_g=0.7,
        salt_g=0.15,
    ),
    ...
    _food(
        ...
        6.0,
        0.0,
        aliases=("ternera", "filete de ternera"),
        sat_fat_g=2.4,
        salt_g=0.15,
    ),
    _food(
        ...
        10.0,
        0.0,
        aliases=("carne picada", "carne de ternera"),
        sat_fat_g=4.0,
        salt_g=0.16,
    ),
    _food(
        "cerdo_lomo", "Lomo de cerdo", 143, 21.0, 6.0, 0.0, aliases=("cerdo", "lomo cerdo"), sat_fat_g=2.1, salt_g=0.14
    ),
    ...
    _food(
        ...
        20.0,
        1.0,
        aliases=("hamburguesa", "burger vacuno"),
        sat_fat_g=8.0,
        salt_g=1.0,
    ),
    _food(
    ...
    _food(
        ...
        1.0,
        0.0,
        aliases=("atun natural", "lata atun natural"),
        sat_fat_g=0.3,
        salt_g=1.0,
    ),
    _food(
        ...
        11.0,
        0.0,
        aliases=("atun aceite", "lata atun aceite"),
        sat_fat_g=2.0,
        salt_g=1.0,
    ),
    ...
    _food(
        ...
        1.3,
        0.0,
        aliases=("filete de merluza", "pescado blanco"),
        sat_fat_g=0.3,
        salt_g=0.2,
    ),
    ...
    _food(
        "garbanzos_cocidos", "Garbanzos cocidos", 164, 8.9, 2.6, 27.4, aliases=("garbanzos",), fiber_g=7.6, salt_g=0.02
    ),
    _food(
        "alubias_cocidas",
        "Alubias cocidas",
        ...
        0.5,
        22.8,
        aliases=("judias cocidas", "frijoles"),
        fiber_g=6.4,
        salt_g=0.02,
    ),
    ...
    _food(
        ...
        4.8,
        aliases=("leche",),
        nutrition_basis=NutritionBasis.per_100ml,
        sat_fat_g=2.1,
        sugars_g=4.8,
        salt_g=0.1,
    ),
    ...
    _food(
        ...
        0.2,
        5.0,
        aliases=("leche desnatada", "leche sin grasa"),
        nutrition_basis=NutritionBasis.per_100ml,
        sat_fat_g=0.1,
        sugars_g=5.0,
        salt_g=0.1,
    ...
    _food(
        ...
        0.4,
        6.6,
        aliases=("brocoli cocido", "brocoli al vapor"),
        sugars_g=1.7,
        fiber_g=2.6,
    ),
    ...
    _food(
        ...
        0.3,
        3.3,
        aliases=("setas laminadas", "mushrooms"),
        sugars_g=2.0,
        fiber_g=1.0,
    ),
    _food(
        ...
        0.0,
        10.6,
        aliases=("coca-cola", "cocacola", "cola refresco"),
        nutrition_basis=NutritionBasis.per_100ml,
        sugars_g=10.6,
        salt_g=0.02,
    ),
    _food(
        ...
        0.0,
        0.0,
        aliases=("coca-cola zero", "cocacola zero", "coke zero"),
        nutrition_basis=NutritionBasis.per_100ml,
        sugars_g=0.0,
        salt_g=0.02,
    ),
    ...
    _food(
        ...
        0.0,
        4.6,
        aliases=("aquarius", "isotonica limon"),
        nutrition_basis=NutritionBasis.per_100ml,
        sugars_g=4.6,
        salt_g=0.12,
    ),
    _food(
        "agua", "Agua", 0, 0.0, 0.0, 0.0, aliases=("agua mineral", "water"), nutrition_basis=NutritionBasis.per_100ml
    ),
    _food(
        "cafe_solo",
        "Cafe solo",
    ...
    _food(
        ...
        20.0,
        67.0,
        aliases=("digestive", "galletas digestive"),
        sat_fat_g=7.0,
        sugars_g=20.0,
        fiber_g=4.5,
        salt_g=0.8,
    ...
    _food(
        ...
        50.0,
        20.0,
        aliases=("mantequilla de cacahuete",),
        sat_fat_g=10.0,
        sugars_g=9.0,
        fiber_g=6.0,
        salt_g=0.5,
